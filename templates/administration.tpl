...
<head>
  ...
  <title>Administration - CID</title>
...
<h1>Page d'administration</h1>
  ...
  <div class="page_admin">
    <div class="container">
      Gestion adhérents
      <div><a href="liste-adherent-no-visible"><button class="btn" type="button">Ajout adhérents</button></div>
      <div><a href="liste-adherent"><button class="btn" type="button">Liste adhérents</button></a></div>
    </div>
    <div class="container">
      Gestion Photos
      <div><a href="liste-photos-no-visible"><button class="btn" type="button">Approbation photos</button></div>
