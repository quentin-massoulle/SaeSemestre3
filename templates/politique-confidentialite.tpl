...
<head>
  ...
  <title>Politique de confidentialité - CID</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="contenue">
      <div class="content">
        <p>Le site web CID est détenu par Cercle des informaticiens dispersé, qui est un contrôleur de données de vos données personnelles.</p>
        <p>Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par CID , qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de CID.</p>
        ...
        <p><b>Sécurité de l'information :</b></p>
        ...
        <p><b>Informations de contact :</b></p>
        <p>Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à cid@gmail.com.</p>
      </div>
    </div>
  </div>
